...
(function () {
  ...
  var T = {
    en: {
      ...
      'res.locationVal': 'Kazanchis, Addis Ababa — Near the Intercontinental Hotel',
      'res.contactUs': 'Contact Us',
      'res.contactVal': '+251 931 190 440 · +251 912 934 982',
      ...
      'cart.phone': 'Phone (optional)',
      'cart.email': 'Email for confirmation (optional)',
      'cart.notes': 'Special requests or notes...',

      // Order page
      'order.table': 'Table',
      'order.scanHint': 'Your order will be sent to the kitchen when a member of staff checks it.',
      'order.noParams': 'Missing table code. Please scan a table QR code from your table.',
      'order.invalidKey': 'This table code is not recognised. Please ask staff for a fresh table card.',
      'order.checkIn': 'Check in at {table}',
      'order.backToMenu': 'Back to Menu',
      'order.noMenu': 'We could not load the menu right now. Try again in a moment.',
    ...
    am: {
      ...
      'res.location': 'አካባቢ',
      'res.locationVal': 'ካዛንቺስ፣ አዲስ አበባ — ከ ኢንተርኮንቲኔንታል ሆቴል ጋር',
      'res.contactUs': 'ያግኙን',
      'res.contactVal': '+251 931 190 440 · +251 912 934 982',
      ...
      'cart.sending': 'ቨርታንይ ነው...',
      'cart.retry': 'እንደገና ይህዝ',
      ...
      'cart.name': 'ስምህ (ኮማንድ)',
      'cart.phone': 'ስልክ (ኮማንድ)',
      'cart.email': 'ኢሜይል ለማረጋገጥ (ኮማንድ)',
      'cart.notes': 'ልዩ ጥያቄዎች ወይም ምስላ ቃል...',

      // Order page
      'order.table': 'ጣቢያ',
      'order.scanHint': 'ትዕዛዙ ከአንድ የትምህርት አባላት በመረጃ ወደ ቤተርህ ይሠላል።',
      'order.noParams': 'የጣቢያ ኮድ ሄደ አላቸው። እባክዎ ከጣቢያዎች የተፈጠረ QR ኮድ ያՃանանաᬋል።',
      'order.invalidKey': 'የጣቢያ ኮድ አልተገኘም። እባክዎ ከተማቸጋው አባላት ጋር ይገኙ።',
      'order.checkIn': '{table} ድምጿ',
      'order.backToMenu': 'ወደ ዝርዝር ይመለስ',
      'order.noMenu': 'ዝርዝሩ አሁን አልቀረበልም። በትንህና ይሼል።',
      'order.tryAgain': 'እንደገና ይህዝ',
      'order.loading': 'ዝርዝር ታየሰ ነው…',
