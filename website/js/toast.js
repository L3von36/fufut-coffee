...
(function initToastSystem() {
  ...
  function getStyles() {
    var g = CONFIG.gap;
    var a = ANIM_MS;
    return '.toast-container{position:fixed;pointer-events:none;z-index:9999;display:flex;flex-direction:column;gap:' + g + 'px;padding:16px;max-width:100%;box-sizing:border-box}'
